...
// --- 配置宏 ---
#define ACTION_INTERVAL_MS  500   // 动作每一步的间隔时间
...
static const pose_frame_t DATA_ROT_L[] = {
    // Frame 0: LT_H(120), RB_H(120), LT_K(60), RB_K(60)
    { {60, 120, 90, 90, 60, 120, 90, 90} },
    
    // Frame 1: 复杂切换
    // LT_H(150), RB_H(150), RT_H(120), LB_H(120)
    // RT_K(90), LB_K(90), LT_K(30), RB_K(30)
    { {30, 150, 90, 120, 30, 150, 90, 120} }, 

    // Frame 2: 复位过程
    { {90, 90, 120, 150, 90, 90, 120, 150} }, 
...
static const pose_frame_t DATA_ROT_R[] = {
    // Frame 0: LT_H(60), RB_H(60), LT_K(60), RB_K(60)
    { {60, 60, 90, 90, 60, 60, 90, 90} },
    
    // Frame 1
    { {30, 30, 90, 60, 30, 30, 90, 60} }, 

    // Frame 2
    { {90, 90, 120, 30, 90, 90, 120, 30} },
